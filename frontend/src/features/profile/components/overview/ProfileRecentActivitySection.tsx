  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {activities.length === 0 ? (
          <div className="rounded-lg border border-dashed border-border/70 bg-card/25 p-3 text-sm text-muted-foreground">
          ...
          activities.map((item) => (
            <Link
              ...
              viewTransition
            >
              <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full border border-primary/25 bg-primary/10">

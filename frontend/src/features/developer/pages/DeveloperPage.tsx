...
const { border, rowBorder, shellBackground, panelBackground, mutedText, dimText } = uiColors;
...
export const DeveloperPage = () => {
  ...
  const handleExploreClick = () => {
    document.getElementById("api-surface")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  return (
    <div className="min-h-screen" style={{ background: shellBackground, color: "var(--foreground)" }}>
      <div className="mx-auto max-w-5xl px-4 py-8">
        <header className="mb-10 border-b pb-8" style={{ borderColor: border }}>
          ...
          <p className="max-w-2xl font-mono text-sm leading-relaxed" style={{ color: mutedText }}>
            Build small integrations with your public data. Interis exposes a simple public API for profile
            data, top picks, recent activity, reviews, watchlist, diary entries, and more. Use it for personal
        ...
        <section className="mb-10">
          <p className="mb-5 font-mono text-[10px] uppercase tracking-[0.18em] text-primary">/ What You Can Do</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <h2 className="mb-1 font-mono text-xs font-semibold text-foreground">{item.title}</h2>
                    <p className="font-mono text-[10px] leading-relaxed" style={{ color: mutedText }}>
                      {item.description}
                    </p>
                  </div>
                </article>
        ...
        <section id="api-surface" className="mb-10">
          <p className="mb-1 font-mono text-[10px] uppercase tracking-[0.18em] text-primary">/ Public API Surface</p>
          ...
          <div className="overflow-hidden border" style={{ borderColor: border }}>
            <div
              ...
              style={{ borderColor: border, background: panelBackground }}
            >
              <span className="font-mono text-[9px] uppercase tracking-[0.18em]" style={{ color: dimText }}>
                / Endpoint
              </span>
              <span className="hidden font-mono text-[9px] uppercase tracking-[0.18em] sm:block" style={{ color: dimText }}>
                / Description
              </span>
            </div>
            ...
            {publicSurface.map((endpoint, index) => (
              <div
                ...
                style={{
                  ...
                  background: index % 2 ? "color-mix(in srgb, var(--primary) 4%, transparent)" : "transparent",
                }}
              >
                <div className="flex min-w-0 shrink-0 items-center gap-2 sm:w-80">
                  <ChevronRight className="h-3 w-3 shrink-0" style={{ color: "var(--module-cinema)" }} />
                  <code className="truncate font-mono text-[10px]" style={{ color: "var(--primary)" }}>
                    {endpoint.path}
                  </code>
                </div>
                <p className="flex-1 font-mono text-[10px] leading-relaxed" style={{ color: mutedText }}>
        ...
        <section className="mb-10">
          <p className="mb-5 font-mono text-[10px] uppercase tracking-[0.18em] text-primary">/ Mini Examples</p>
          <div className="border" style={{ borderColor: border }}>
            <div className="no-scrollbar flex overflow-x-auto border-b" style={{ borderColor: border, background: panelBackground }}>
            ...
            <div className="px-5 py-4" style={{ background: "color-mix(in srgb, var(--background) 68%, black)" }}>
        ...
        <section>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="font-mono text-[10px] leading-relaxed" style={{ color: mutedText }}>
                The complete API documentation is available at docs.interis.gorkemkaryol.dev with endpoint
                reference, response notes, and practical examples.
              </p>
            </div>

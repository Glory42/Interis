      ...
      <div className="mb-10 border-b border-border/60 pb-8">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-6">
          <div className="flex items-center gap-2">
            <span className="h-1.5 w-1.5 animate-pulse  bg-[var(--module-cinema)]" />
            <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
              LIVE_REVIEWS:
            </span>
            <span className="font-mono text-[11px] font-bold text-[var(--module-cinema)]">
              {liveReviews}
            </span>
          </div>

          <div className="flex items-center gap-2">
            <span className="h-1.5 w-1.5 animate-pulse  bg-[var(--module-serial)]" />
            <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
              TOTAL_USERS:
            </span>
            <span className="font-mono text-[11px] font-bold text-[var(--module-serial)]">
              {totalUsers ?? "--"}
            </span>
          </div>

          <div className="flex items-center gap-2">
            <span className="h-1.5 w-1.5 animate-pulse  bg-[var(--module-codex)]" />
            <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
              LOGS_TODAY:
            </span>
            <span className="font-mono text-[11px] font-bold text-[var(--module-codex)]">
              {logsToday}
            </span>
          </div>
        </div>

          ...
          {showInteractions && episode.viewerInteraction && (
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="flex h-6 rounded-full px-1.5 items-center justify-center border font-mono text-[8px] uppercase font-bold transition-colors hover:bg-secondary/40"
                style={{
              ...
              <button
                ...
                className="flex h-6 w-6 items-center justify-center rounded-full border transition-colors hover:bg-secondary/40"
                style={{
              ...
              <button
                ...
                className="flex h-6 rounded-full px-1.5 items-center gap-1 border font-mono text-[8px] uppercase font-bold transition-colors hover:bg-secondary/40"
                style={{

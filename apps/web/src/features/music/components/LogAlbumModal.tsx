          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-4 pt-3 sm:px-5 sm:pb-5 sm:pt-4">
            <div className="grid gap-4 sm:grid-cols-[100px_1fr]">
              <div className="flex items-start justify-center sm:block">
                ...
                >
                  {coverArtUrl ? (
                    <img src={coverArtUrl} alt={`${albumTitle} cover`} className="h-full w-full object-cover" />
                  ) : (
                    <div className="flex h-full w-full items-center justify-center" style={{ background: MUSIC_MODULE_STYLES.panelSoft }}>

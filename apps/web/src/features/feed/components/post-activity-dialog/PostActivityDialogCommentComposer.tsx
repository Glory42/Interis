    ...
    <div className="space-y-2 border-t border-border/60 pt-4">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="rounded-full border border-primary/45 bg-primary/10 px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.12em] text-primary transition-colors hover:bg-primary/20 disabled:cursor-not-allowed disabled:opacity-50"
        >
          {isSubmittingComment ? (

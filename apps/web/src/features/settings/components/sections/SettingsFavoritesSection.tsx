        ...
        <div className="space-y-6">
          <div>
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] uppercase tracking-[0.16em]" style={{ color: "var(--module-cinema)" }}>
                Cinema
              </span>
          ...
          <div>
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] uppercase tracking-[0.16em]" style={{ color: "var(--module-serial)" }}>
                Serial
              </span>
              <span className="font-mono text-[9px] settings-shell-muted">
          ...
          <div>
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] uppercase tracking-[0.16em]" style={{ color: "var(--module-music)" }}>
                Music
              </span>
              <span className="font-mono text-[9px] settings-shell-muted">
          ...
          <div>
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] uppercase tracking-[0.16em]" style={{ color: "var(--module-book)" }}>
                Books
              </span>
              <span className="font-mono text-[9px] settings-shell-muted">

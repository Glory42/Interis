...
// The movie archive is backed by TMDB's real trending catalog, which
...
const ARCHIVE_ITEM_LINK_SELECTOR = 'a[href^="/movies/"]';
const ARCHIVE_PAGE_SIZE = 30;

test("loads more movie archive results on demand", async ({ page }) => {

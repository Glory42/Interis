...
| `/api/public/:username/movies/watched` | 50 | 200 | Watched movies (movie-only) |
...
- Movies watched / serials watched are each movie-only or series-only (unlike likes/watchlist, which mix both media types).
